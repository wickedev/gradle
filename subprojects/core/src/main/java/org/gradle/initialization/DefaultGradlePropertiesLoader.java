...
public class DefaultGradlePropertiesLoader implements IGradlePropertiesLoader {
    ...
    LoadedGradleProperties loadProperties(File rootDir, StartParameterInternal startParameter, Map<String, String> allSystemProperties, Map<String, String> envProperties) {
        ...
        addProperties(defaultProperties, systemProperties, new File(startParameter.getGradleHomeDir(), GRADLE_PROPERTIES));
        addProperties(defaultProperties, systemProperties, new File(rootDir, GRADLE_PROPERTIES));
        addProperties(overrideProperties, systemProperties, new File(startParameter.getGradleUserHomeDir(), GRADLE_PROPERTIES));
        ...
        return new DefaultLoadedGradleProperties(
            ...
            getNonProjectSystemPropertiesFrom(startParameter)
        );
    }
    ...
    private void addProperties(Map<String, String> gradleProperties, Map<String, String> systemProperties, File... files) {
